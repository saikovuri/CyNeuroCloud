<div id="page2" ng-show="page2">
   ...
   <div class="form-actions" style="display: block" id="button2">
      <input type="Submit" ng-click="changeView('view1')" class="btn btn-primary" value="Back" id="click2">&nbsp  &nbsp
      <input type="Submit" ng-click="changeView('view3')" class="btn btn-primary" value="Next" >
   </div>
   </form> 
</div>
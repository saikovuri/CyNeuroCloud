<div class="row" id="page3" ng-show="page3">
   <div class="container">
      ...
      <div class="form-actions" style="display: block" id="button3">
         <input type="Submit" ng-click="changeView('view2')" class="btn btn-primary" value="Back" >&nbsp  &nbsp
         <input type="Submit" ng-click="changeView('view4')" class="btn btn-primary" value="Next" >
      </div>
   </div>
</div>
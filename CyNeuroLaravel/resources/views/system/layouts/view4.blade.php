...
<div class="container jumbotron padding-top-10 padding-bottom-5" style="width: 100%;" >
   ...
   <div class="form-actions" style="display: block" id="button4">
         <input type="Submit" ng-click="changeView('view3')" class="btn btn-primary" value="Back" >&nbsp  &nbsp
         <input type="Submit" ng-click="changeView('view5')" class="btn btn-primary" value="Next" >
      </div>
</br>
</br>
</br>

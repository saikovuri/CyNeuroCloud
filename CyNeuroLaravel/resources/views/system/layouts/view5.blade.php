...
<div class="form-actions" style="display: block" id="button5">
         <input type="Submit" ng-click="changeView('view4')" class="btn btn-primary" value="Back" >&nbsp  &nbsp
         <input type="Submit" ng-click="changeView('view6')" class="btn btn-primary" value="Next" >
      </div>
</br></br>
